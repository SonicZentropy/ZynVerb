...
#ifndef JUCE_NewAudioProcessorGraph_H_INCLUDED
#define JUCE_NewAudioProcessorGraph_H_INCLUDED
...
*/
class JUCE_API  NewAudioProcessorGraph : public AudioProcessor,
	private AsyncUpdater
{
public:
	//==============================================================================
	/** Creates an empty graph. */
	NewAudioProcessorGraph();
	...
	*/
	...
	//==============================================================================
	/** Represents one of the nodes, or processors, in an NewAudioProcessorGraph.

	To create a node, call NewAudioProcessorGraph::addNode().
	*/
	...
	private:
		//==============================================================================
		friend class NewAudioProcessorGraph;
		...
		void setParentGraph(NewAudioProcessorGraph*) const;
		void prepare(double newSampleRate, int newBlockSize, NewAudioProcessorGraph*);
		void unprepare();
	...
	//==============================================================================
	/** Represents a connection between two channels of two nodes in an NewAudioProcessorGraph.

	To create a connection, use NewAudioProcessorGraph::addConnection().
	*/
	...
	public:
		...
		@see NewAudioProcessorGraph::getNodeForId
		*/
		uint32 sourceNodeId;
		...
		If this value is the special number NewAudioProcessorGraph::midiChannelIndex, then
	...
	*/
	...
	//==============================================================================
	/** A special type of AudioProcessor that can live inside an NewAudioProcessorGraph
	...
	*/
	...
	public:
		...
		*/
		...
		NewAudioProcessorGraph* getParentGraph() const noexcept { return graph; }
		...
		//==============================================================================
		explicit AudioGraphIOProcessor(const IODeviceType type);
		...
		/** @internal */
		void setParentGraph(NewAudioProcessorGraph*);
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(NewAudioProcessorGraph)
};


#endif   // JUCE_NewAudioProcessorGraph_H_INCLUDED
